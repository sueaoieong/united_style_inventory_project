...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 501, 291))
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox.setItemText(0, _translate("Form", "Barcode"))
        self.comboBox.setItemText(1, _translate("Form", "post ID"))
